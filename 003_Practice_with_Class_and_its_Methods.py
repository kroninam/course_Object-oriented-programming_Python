...
#
# метод __init__, который должен приманить экземпляр TaskList  и сохранять его в атрибуте  task_list
#
...
#
# метод  show_tasks, который хранящейся задачи в списке вызывает метод display
#
